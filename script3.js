...
function generateContactInfoSection(email, website, phone, address) {
    ...
    if (document.getElementById('email2').checked) {
        contactMethods.push(`<li>Email Address: ${email}</li>`);
    }
    ...
    if (document.getElementById('phone2').checked) {
        contactMethods.push(`<li>Phone Number: ${phone}</li>`);
    }
...
function createTemplate(organization, websiteURL, websiteName, state, personalInfoList, contactInfoSection) {
    ...
    <ul>
      ...
      <li>Public Sources: We may collect information about you from publicly available sources such as data brokers, social media platforms, and other organizations.</li>
    </ul>
    ...
    <ul>
      ...
      <li>To send periodic emails to users</li>
      <li>To personalize user experience on our website</li>
      <li>To contact users via phone</li>
      <li>To send postal mail to</li>
    </ul>
    ...
    <ul>
      ...
      <li>Responding "Stop" to a text message to unsubscribe from text message communications</li>
